    ...
    lazy var tousLesUtilisateurs: NSFetchedResultsController<Utilisateur> =
        {
            ...
            request.sortDescriptors = [NSSortDescriptor(key: #keyPath(Utilisateur.possederTypeUtilisateur.libelleTypeUtilisateur), ascending: false), NSSortDescriptor(key: #keyPath(Utilisateur.nom), ascending: true)]
